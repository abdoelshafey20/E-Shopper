                        ...
                        <div className="row">
                            <div className="col-md-4 mb-5">
                                ...
                                <div className="d-flex flex-column justify-content-start">
                                    ...
                                    <Link className="text-dark mb-2" to="/shoppingcart"><i className="fa fa-angle-right mr-2"></i>Shopping Cart</Link>
                ...
                <div className="row border-top border-light mx-xl-5 py-4">
                    <div className="col-md-6 px-xl-0">
                        <p className="mb-md-0 text-center text-md-left text-dark">
                            &copy; <a className="text-dark font-weight-semi-bold" to="#">Your Site Name</a>. All Rights Reserved. Designed
                            by
                            <a className="text-dark font-weight-semi-bold" to="https://htmlcodex.com">HTML Codex</a>
                        </p>
                    </div>
